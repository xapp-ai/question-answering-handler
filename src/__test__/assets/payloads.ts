...
export const VARIABLES_WITH_CHAT: ResultVariables = {
    "IS_QUESTION": true,
    "CHAT_RESPONSE": {
        "text": "Michael Myers has a Bachelor of Science degree from the University of Virginia.",
        "markdownText": "Michael Myers has a Bachelor of Science degree from the University of Virginia.",
        "sources": [
            {
                "title": "Read more",
